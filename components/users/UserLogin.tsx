...
const UserLogin = ({isPatient}: { isPatient: boolean }) => {
    const backgroundImage : string = isPatient ? "/assets/images/patient-login.png" : "/assets/images/onboarding-img.png";
   ...
   return (<div className="flex h-screen max-h-screen">
       <section className="remove-scrollbar container my-auto">
           <div className="sub-container max-w-[496px]">
               ...
               {isPatient && <div className="mt-2 justify-items-end text-dark-600 xl:text-right">
